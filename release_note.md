# ESPHome Client App Release Notes — v1.2.0 to v1.2.4

This document lists the new features, user experience enhancements, performance optimizations, and bug fixes introduced in the ESPHome Client App from version `1.2.0` up to the current version `1.2.4`.
