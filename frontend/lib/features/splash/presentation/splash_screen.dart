...
class _IotDiscoveryAnimationState extends State<IotDiscoveryAnimation>
        ...
        children: [
          ...
          ScaleTransition(
            ...
            child: Container(
              ...
              child: Icon(Icons.sensors, size: 38, color: theme.primaryColor),
            ),
          ),
        ],
      ),
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (var node in nodes) {
      ...
      if (progress > delay) {
        ...
        final currentOffset =
            center + Offset(destX * lineProgress, destY * lineProgress);
  ...
  void _drawDashedLine(Canvas canvas, Offset p1, Offset p2, Paint paint) {
    ...
    while (drawn < distance) {
      ...
      canvas.drawLine(
        ...
        Offset(
          nextX > p2.dx && dx > 0 ? p2.dx : nextX,
          nextY > p2.dy && dy > 0 ? p2.dy : nextY,
        ),
        paint,
      );
